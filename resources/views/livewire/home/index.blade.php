<section class="bg-gray-700 bg-center bg-no-repeat bg-blend-multiply banner home-content">
    <div class="max-w-screen-xl px-6 py-24 mx-auto text-center lg:py-56">
        ...
        <div class="flex flex-col space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
            ...
            <a wire:navigate.hover href="{{ route('home.services') }}" class="inline-flex items-center justify-center px-5 py-3 text-base font-medium text-center text-white border border-white rounded-lg hover:text-gray-900 hover:bg-gray-100 focus:ring-4 focus:ring-gray-400">
                Nuestros servicios
            </a>
        </div>
    </div>
