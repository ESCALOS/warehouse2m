...
<nav class="bg-white border-gray-200 dark:bg-gray-900 home-nav">
    <div class="flex flex-wrap items-center justify-between max-w-screen-xl p-4 mx-auto" x-data="{ isOpen: true }">
        ...
        <div class="flex items-center md:order-2">
            <button @click="isOpen = !isOpen" type="button" class="inline-flex items-center justify-center w-10 h-10 p-2 text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        ...
        <div class="items-center justify-between w-full md:flex md:w-auto md:order-1" :class="{ 'hidden': isOpen }">
